...
- <click:run_command:/tptime><hover:show_text:'<gray>Click to run</gray>'><green>/tptime</green></click> - Shows your total playtime.
- <click:copy_to_clipboard:tptime {player}><hover:show_text:'<gray>Click to copy</gray>'><green>/tptime {player}</green></click> - Shows specified player's playtime.
