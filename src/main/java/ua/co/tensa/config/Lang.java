...
public enum Lang {
    ...
    meta_need_player("meta_need_player"),
    meta_set_ok("meta_set_ok"),
    meta_get_ok("meta_get_ok"),
    meta_deleted_ok("meta_deleted_ok"),
    meta_no_meta("meta_no_meta"),
    meta_list_header("meta_list_header");
